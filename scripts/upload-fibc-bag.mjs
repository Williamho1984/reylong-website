...
const remote = 'news/fibc/fibc-bag.jpg'
const { error } = await supabase.storage.from('product-media').upload(remote, readFileSync(join(__dirname, '..', 'fibc-bag.jpg')), { contentType: 'image/jpeg', upsert: true })
